      ...
      <div className="md:flex md:ml-20 flex-row-reverse">
        <div className="">
          <img
            ...
            alt="hero-logo"
            className="w-4/4 md:w-3/4 mt-20 md:mt-20 md:ml-16 ml-20"
          />
        </div>
        <div className="w-96 md:ml-1 md:w-1/2 mt-28">
          ...
          <button className="ml-24 py-2 px-20 bg-orange-600 md:ml-44 md:py-2 md:px-7 rounded-full text-white mt-10 hover:bg-orange-400">
            Join Now
          </button>
          <div className="stats shadow mt-10  md:mr-1">
