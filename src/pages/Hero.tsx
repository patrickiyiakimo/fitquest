    ...
    <div className="font-mont pt-10 md:pt-1">
      <div className="lg:flex md:ml-20 flex-row-reverse">
        ...
        <div className="ml-9 md:ml-1 lg:w-1/2 mt-28">
          ...
          <p className="text-center mt-7  lg::ml-10 md:w-2/4 md:ml-40 lg:ml-1 lg:w-96 text-xl">
            We believe that the potential to achieve desired health and wellness
            goals lies within everyone.
          </p>
          <button className="ml-20 py-2 px-20 bg-orange-600  whitespace-nowrap md:py-4 md:px-72 lg:ml-44 lg:py-2 lg:px-7 rounded-full text-white mt-10 hover:bg-orange-400">
            Join Now
          </button>
          <div>
